...
namespace WinSolution.Module.Win {
    public interface IModelVGridControlViewItem : IModelViewItem {    }
    [DetailViewItemAttribute(typeof(IModelVGridControlViewItem))]
    public class VGridControlViewItem : ViewItem, IComplexPropertyEditor {
        public VGridControlViewItem(IModelVGridControlViewItem model, Type classType) : base(classType, model.Id) { }
        private VGridControl vGridControlCore;
        public VGridControl VGridControl {
            get {
                return vGridControlCore;
            }
        }
        private XafApplication applicationCore;
        ...
        protected override object CreateControlCore() {
            ...
            foreach (IModelViewItem item in dw.Items) {
                ...
                if (modelPropertyEditor != null) {
                    ...
                    if (repositoryItem != null) {
                        ...
                        if (mi != null) {
                            ...
                            row.Properties.Caption = ((IModelCommonMemberViewItem)modelPropertyEditor).Caption;
        ...
        private IList GetDataSource() {
            XPCollection ds = new XPCollection(((ObjectSpace)View.ObjectSpace).Session, ObjectType, false);
