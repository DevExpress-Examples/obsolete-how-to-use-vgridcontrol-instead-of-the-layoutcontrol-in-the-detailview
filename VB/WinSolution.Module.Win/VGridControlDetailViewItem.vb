...
Namespace WinSolution.Module.Win
  ...
  Public Class VGridControlDetailViewItem
        ...
        Protected Overrides Function CreateControlCore() As Object
            ...
            Dim dw As IModelDetailView = DirectCast(View.Model, IModelDetailView)
            For Each item As IModelDetailViewItem In dw.Items
                Dim modelPropertyEditor As IModelPropertyEditor = TryCast(View.Model, IModelPropertyEditor)
                If Not (modelPropertyEditor Is Nothing) Then
